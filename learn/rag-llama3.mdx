---
title: "Build a 'Chat with your website' locally using Llama 3"
description: "Learn how to use Firecrawl, Llama 3 (using Ollama), and Langchain to build a 'Chat with your website' bot."
---
...
Then, open your favorite terminal and let's install LLama 3:

```bash
ollama run llama3
```

Next, install our python dependencies, including langchain, faiss, ollama, and firecrawl-py
...
## Generation
Last but not least, you can use the Ollama to generate a response to a question based on the documents we have loaded.
...
You have now built a 'Chat with your website' bot using Llama 3, Ollama, Langchain, and Firecrawl. You can now use this bot to answer questions based on the documentation of your website.
