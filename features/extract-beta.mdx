...
If you want to improve the results of the extraction, you can pass an `allowExternalLinks` parameter to the endpoint. This will allow it to attempt to find the data from external links - outside the scope of the provided URLs.
