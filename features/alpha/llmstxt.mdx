...
icon: "file-text"
sidebarTitle: "Generate LLMstxt (Alpha)"
---
...
## Introducing LLMs.txt Generator (Alpha) 📃
...
- **maxUrls** (Optional): Maximum number of pages to crawl (1-1000, default: 20)
...
LLMs.txt generation runs asynchronously. Monitor the status with:
