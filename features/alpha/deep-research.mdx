...
While in Alpha we use a combination of small models to explore the web and synthesize information. This can result in the synthesis not being very long and detailed. If you'd like us to offer more powerful models, let us know at [help@firecrawl.dev](mailto:help@firecrawl.dev).
