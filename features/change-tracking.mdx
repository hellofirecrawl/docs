...
The change tracking feature allows you to monitor and detect changes in web content over time. This feature is available in both the JavaScript and Python SDKs.

  ![Change Tracking](images/launch-week/lw3d1-2.webp)
