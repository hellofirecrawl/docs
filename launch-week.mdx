...
We’ve introduced a fully async Python SDK, powerful new features in the Rust SDK, expanded team support on every plan, and a brand new Firecrawl Dark Theme for VSCode and compatible editors.

### Key Features
- **Async Python SDK**: No blocking, ready for production, plays well with FastAPI and Django.
